...
# Install Ceres
RUN wget -O ceres-solver-2.2.0.zip https://github.com/ceres-solver/ceres-solver/archive/refs/tags/2.2.0.zip && \
    unzip ceres-solver-2.2.0.zip && \
    ...
    make install && \
    cd ../.. && \
    rm -rf ceres-solver-2.2.0.zip ceres-solver-2.2.0
